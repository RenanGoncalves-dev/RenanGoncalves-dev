# Hi there, I'm Renan Bernardo Gonçalves 👋
...
🎓 **Análise e Desenvolvimento de Sistemas (TADS)** @ Instituto Federal do Espírito Santo (IFES)  
🛠️ **Maker & Desenvolvedor IoT** | Impressão 3D & Prototipagem Física  
📍 Espírito Santo, Brasil

### 🚀 Sobre Mim

Desenvolvedor em formação focado na construção de soluções completas — integrando **software, hardware e modelagem física**. Atuo ativamente no **Laboratório Maker do IFES**, desenvolvendo projetos práticos que vão desde a modelagem e impressão 3D de envoltórios (cases) até a programação de sistemas embarcados para **Internet das Coisas (IoT)** e desenvolvimento web/mobile.

- 🔭 **Atualmente cursando:** Programação Aplicada a IoT, Desenvolvimento Back-End e Banco de Dados II no IFES.
- 🖨️ **Prototipagem Maker:** Experiência prática com modelagem e impressão 3D para manufatura de cases de controle de alarmes, suportes e estruturas de motores.
- 💡 **Interesses:** Internet das Coisas (IoT), Sistemas Embarcados, Desenvolvimento Web/Mobile e Automação.
...
#### 📡 IoT & Prototipagem Maker
![C++](https://img.shields.io/badge/C%2B%2B-00599C?style=for-the-badge&logo=c%2B%2B&logoColor=white)
![Arduino](https://img.shields.io/badge/Arduino-00979D?style=for-the-badge&logo=arduino&logoColor=white)
![ESP32](https://img.shields.io/badge/ESP32-E7352C?style=for-the-badge&logo=espressif&logoColor=white)
![3D Printing](https://img.shields.io/badge/Impressão_3D-0288D1?style=for-the-badge&logo=ultimaker&logoColor=white)
![n8n](https://img.shields.io/badge/n8n-FF6584?style=for-the-badge&logo=n8n&logoColor=white)

### 🔬 Experiência Prática — Laboratório Maker & IoT (IFES)

#### 🖨️ Prototipagem Digital & Impressão 3D
...
🎓 **Systems Analysis and Development** @ Federal Institute of Espírito Santo (IFES)  
🛠️ **Maker & IoT Developer** | 3D Printing & Physical Prototyping  
...
- 🖨️ **Maker Prototyping:** Hands-on experience in 3D modeling and additive manufacturing for custom alarm control cases, brackets, and motor housing structures.
...
#### 🖨️ Digital Fabrication & 3D Printing
